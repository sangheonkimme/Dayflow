        ...
        <div className="salary-col">
          ...
          <div className="card card-pad salary-card salary-options">
            ...
            <div className="salary-field">
              ...
              <div className="salary-seg">
                <button
                  className={severance === "separate" ? "on" : ""}
                  onClick={() => setSeverance("separate")}
                >
                  별도
                </button>
                <button
                  className={severance === "included" ? "on" : ""}
          ...
          <div className="card card-pad salary-card payslip">
            ...
            <div className="payslip-group">
              ...
              <div className="pg-row sub">
                <span>
                  국민연금 (4.5%) <i className="qmark">?</i>
                </span>
                <span>{won(r.np)} 원</span>
              </div>
              <div className="pg-row sub">
                <span>
                  건강보험 (3.545%) <i className="qmark">?</i>
                </span>
                <span>{won(r.hi)} 원</span>
              </div>
              <div className="pg-row sub">
                <span>
                  장기요양보험료 (12.95%) <i className="qmark">?</i>
                </span>
                <span>{won(r.ltc)} 원</span>
              </div>
              <div className="pg-row sub">
                <span>
                  고용보험 (0.9%) <i className="qmark">?</i>
                </span>
            ...
            <div className="payslip-group">
              ...
              <div className="pg-row sub">
                <span>
                  소득세 (기본) <i className="qmark">?</i>
                </span>
                <span>{won(r.baseIncomeTax)} 원</span>
              </div>
              <div className="pg-row sub">
                <span>
                  소득세 <i className="qmark">?</i>
                </span>
                <span>{won(r.incomeTax)} 원</span>
              </div>
              <div className="pg-row sub">
                <span>
                  지방소득세 (10%) <i className="qmark">?</i>
                </span>
