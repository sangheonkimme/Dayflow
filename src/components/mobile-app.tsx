...
import { MobileCalendar, MobileCalEvents } from '@/pages/mobile/tabs/calendar';
...
function ChallengeDetailSheet({ challenge, onClose, onJoin, onLeave }) {
  ...
  useEffect(() => { if (open) setJustJoined(false); }, [open, challenge && challenge.id]);
