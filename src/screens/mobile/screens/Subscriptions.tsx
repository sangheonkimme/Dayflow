...
export const SubscriptionsScreen = ({ onBack, onAdd }: any) => {
  ...
  const visible =
    filter === "전체" ? subs : subs.filter((s) => s.cat === filter);
      ...
      >
        ...
        <div style={{ display: "flex", gap: 14, marginTop: 12, fontSize: 11 }}>
          <span>
            ...
            <div style={{ color: "var(--ink-mute)" }}>엔터테인먼트</div>
          </span>
          <span>
            <b style={{ fontFamily: "var(--mono)", fontSize: 13 }}>
              ₩
            ...
            <div style={{ color: "var(--ink-mute)" }}>업무</div>
          </span>
          <span>
            <b style={{ fontFamily: "var(--mono)", fontSize: 13 }}>
              ₩
            ...
            <div style={{ color: "var(--ink-mute)" }}>유틸리티</div>
          </span>
        </div>
      </div>
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <small style={{ fontSize: 11, color: "var(--ink-mute)" }}>
                {s.daysAway === 0 ? "오늘" : `${s.daysAway}일 후`} · 매월{" "}
                {s.day}일
              </small>
            </div>
        ...
        {cats.map((c) => (
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              border:
                "1px solid " + (filter === c ? "var(--ink)" : "var(--line)"),
