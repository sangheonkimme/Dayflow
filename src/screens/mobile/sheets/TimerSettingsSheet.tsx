          ...
          <Row label="짧은 휴식" sub="세트 사이 휴식">
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {breakOpts.map((m) => (
                <Chip
                  key={m}
                  active={settings.shortBreak === m}
                  onClick={() => set("shortBreak", m)}
                >
                  {m}분
                </Chip>
              ))}
          ...
          <Row label="긴 휴식" sub={`${settings.sets}세트 후`}>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
              {longBreakOpts.map((m) => (
                <Chip
                  key={m}
                  active={settings.longBreak === m}
                  onClick={() => set("longBreak", m)}
                >
                  {m}분
                </Chip>
              ))}
