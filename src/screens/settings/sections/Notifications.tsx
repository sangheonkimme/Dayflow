  ...
  return (
    <>
      <div className="settings-group">
        ...
        <SettingRow label="할 일 마감 임박" sub="마감 1시간 전 알림" comingSoon>
          <ToggleSwitch on={true} />
        </SettingRow>
        <SettingRow label="일정 시작 전" sub="일정 15분 전 미리 알림" comingSoon>
          <ToggleSwitch on={false} />
        </SettingRow>
        <SettingRow label="정기 구독 결제" sub="결제 3일 전 알림" comingSoon>
          <ToggleSwitch on={true} />
        </SettingRow>
        <SettingRow label="이메일 요약" sub="주간 활동 요약 메일" comingSoon>
          <ToggleSwitch on={false} />
        </SettingRow>
      </div>
      <div className="settings-group">
