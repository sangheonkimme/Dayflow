    ...
    return (
      ...
      >
        ...
        >
          ...
          <Btn
            kind="yellow"
            disabled={!agree || !email || pwd.length < 8 || !name}
          >
            {t.create} →
          </Btn>
          <div
            style={{ textAlign: "center", marginTop: "auto", paddingTop: 12 }}
          >
            <span style={{ fontSize: 13, color: mute }}>
              {t.haveAccount}{" "}
              <a
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 4 }}>
          <div
            style={{ width: 24, height: 4, borderRadius: 2, background: ink }}
          />
          <div
            style={{
              width: 24,
        ...
        <>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <Btn
              kind="primary"
              dark={dark}
              disabled={!agree || !name || pwd.length < 8}
            >
              {t.create}
            </Btn>
          </div>
