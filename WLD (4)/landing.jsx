...
// ============================================================
// LANDING PAGE — Dayflow marketing site
// ============================================================
    ...
    <header className="nav-wrap">
      <nav className="nav">
        ...
        <div className="nav-cta">
          ...
          <a href="#cta" className="btn btn-primary">무료로 시작하기 →</a>
        </div>
        <button
      ...
      <div className={"mobile-menu " + (open ? "is-open" : "")}
        ...
        <div className="mobile-menu-inner">
          ...
          <div className="mobile-menu-cta">
            <a href="#" className="btn btn-ghost" onClick={() => setOpen(false)}>로그인</a>
            <a href="#cta" className="btn btn-primary" onClick={() => setOpen(false)}>무료로 시작하기 →</a>
          </div>
        </div>
      </div>
    </header>
